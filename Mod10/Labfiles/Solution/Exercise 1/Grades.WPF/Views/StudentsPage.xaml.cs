...
namespace Grades.WPF
{
    public partial class StudentsPage : UserControl
    {
        ...
        #region Refresh
        public async void Refresh() // OO: 3a (async)
        {
            ServiceUtils utils = new ServiceUtils();

            
            await utils.GetStudentsByTeacher(SessionContext.UserName, OnGetStudentsByTeacherComplete);  // OO: 3h (await + OnGetStudent...)

            // OO: 3c (flyttat bort kod)
        }
        #endregion
        ...
        private void OnGetStudentsByTeacherComplete(IEnumerable<Student> students)
        {
            ...
            // OO: 3d (dispatchern uppdaterar gränsnittet)
