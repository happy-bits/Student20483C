...
namespace School
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void teachersList_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            this.schoolContext.LoadProperty<Teacher>(this.teacher, s => s.Students); // OO: Laddar även in studenterna (kan troligen skippa denna rad)
        ...
        private void studentsList_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.Key)
            {
                ...
                case Key.Enter: 
                    ...
                    // OO: Refactorerad kod (skapat metod)
        ...
        // OO: Här kan vi återanvända EditStudent (slipper duplicerad kod)
        ...
        private void RemoveStudent(Student student)
        {
            ...
            {
                // OO: Studenten markeras för att tas bort (men tas inte bort förrens SaveChanges"
        ...
        {
            //OO: Lösning på hela uppgifen är här (förutom att lägga till namespace högst upp)
            try
            {
                // OO: Sparar förändringen till databasen
                // Save the changes
           ...
           // Catch the common exceptions that can occur when saving changes
            catch (OptimisticConcurrencyException)
            {
                ...
                // OO: RefreshMode.ClientWins = efter SaveChanges så används "mitt" värde
    ...
    // OO: konvertera från sträng till decimal

    [ValueConversion(typeof(string), typeof(decimal))] // OO: Lite klart vad detta attribut gör (funkar även utan)
    class AgeConverter : IValueConverter
    {
        public object Convert(
            object value,                               // OO: Datumet
            Type targetType,                            // OO: string
            object parameter,                           // OO: null
            System.Globalization.CultureInfo culture)
        {
            ...
            if (value != null)
            {
                ...
                return ageInYears.ToString(); // OO: Fungerar även utan "ToString"
            }
            else
            {
                return "";
