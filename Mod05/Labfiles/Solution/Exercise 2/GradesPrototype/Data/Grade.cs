...
namespace GradesPrototype.Data
{
    ...
    public abstract class User
    {
        ...
        // OO: 2a (protected så barnen kan ändra det)
        protected string _password = Guid.NewGuid().ToString(); // Generate a random password by default
        public string Password
        {
            set
            {
                // OO: 1b (anropa SetPassword istället för att sätta det direkt)
        ...
        // OO: 1a (barnen kan välja implementation)
    ...
    public class Student: User, IComparable<Student>
    {
        ...
        // OO: 2b (sätter och returnerar boolean hur det gick)
    ...
    public class Teacher : User
    {
        ...
        // OO: 2c (policyn är hårdare för lärare)
