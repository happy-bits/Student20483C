...
{
    public class WordWrapper : IDisposable  // OO: 2a (lägg till IDisposable)
    {
        dynamic _word = null;
        ...
        /*
            OO: Vid Dispose
                ...
                - Anropa "Quit" (för wordapplikationen)
                - Frigör COM-objektet
                - Utför inte "finalizer" för wordWrappern (vet ej varför)
        */
