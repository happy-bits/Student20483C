// OO: Task 1: Skapa databas, kör CreateCertificate.cmd (anropar "makecert")

// OO: All lösningar i denna fil
...
namespace Grades.Utilities
{
    ...
    public class WordWrapper : IDisposable
    {
        ...
        public WordWrapper()
        {
            ...
            this._certificateSubjectName = ConfigurationManager.AppSettings.Get("CertificateName");  // = "CN=Grades" (Common Name)
        }
            ...
            using (var algorithm = new AesManaged())
            {
                ...
                using (var outStream = new MemoryStream())
                {
                    ...
                    using (var encryptor = algorithm.CreateEncryptor())
                    {
                        ...
                        //  OO: BitConverter är inbyggda metoder i System
                        ...
                        var ivLength = BitConverter.GetBytes(algorithm.IV.Length); // OO: IV = Initialization Vector
                        ...
                        using (var encrypt = new CryptoStream(outStream, encryptor, CryptoStreamMode.Write))
                        {
                            ...
                            encrypt.FlushFinalBlock(); // OO: Uppdatera datakällan med innehållet i bufferten, rensa sedan
        ...
        // OO: Denna metod anropas vid kryptering
        ...
        void ValidateX509Config()
        {
            ...
            // OO: Certifikatet hämtas från min dator (med namn CN=Grade)
        ...
        X509Certificate2 GetCertificate()
        {
            var store = new X509Store(
                StoreName.My,                  // OO: Personliga certifikat store
        ...
        public void EncryptAndSaveToDisk(string filePath)
        {
            ...
            // OO: Plocka enkelt utan worddokumentet som XML (!) och omvandla till byte-array
            ...
            File.WriteAllBytes(filePath, encryptedBytes);                   // OO: 4a
