    ...
    public partial class MainWindow : Window, IDisposable
    {
        ...
        private void load_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    // OO: Vid felaktigt lösen så skickas ett exception
                    this.LoadMessage();
                    loadSuccessful = true;
                }
            }
            catch (Exception ex) // CryptographicException
            {
        ...
        // OO: Användare vill kryptera ett meddelande
        private void SaveMessage()
        {
            // Encode'ar till en byte-array
            var decryptedBytes = Encoding.Default.GetBytes(this.messageText.Text);

            // Kryptera (till en ny byte-array)
