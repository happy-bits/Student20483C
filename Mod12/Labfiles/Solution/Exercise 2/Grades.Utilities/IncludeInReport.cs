...
{
    /*
     OO: Används i LocalGrade-klassen t.ex såhär
    ...
    {
        // OO: FormatField är bara en enkel struct
        ...
        public static List<FormatField> GetItemsToInclude(object dataForReport)
        {
            ...
            {
                // OO: Plocka upp vårat egna attribut (IncludeInReportAttribute) från member'n
