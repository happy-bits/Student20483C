...
namespace FourthCoffee.TypeInspector
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void loadButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                // OO: Fyll textrutan med det valda filnamnet
        ...
        private void inspectButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            var type = this.GetType(
                this.pathBox.Text,      // OO: DLL'en
                typeToGet);             // OO: En sträng med typen namn (som vi ska undersöka)
             
            this.membersList.Items.Clear();

            // OO: Hämta properties och metoden mha inbyggda metoder
        ...
        {
            // OO: Töm comboboxen med typerna
            this.typesList.Items.Clear();

            // OO: Ladda in dll'en mha reflection och returnera dess typer
        ...
        private void RenderProperties(PropertyInfo[] properties)
        {
            foreach (var property in properties)
            {
                this.membersList.Items.Add(
                      string.Format(
                         "(property) {0} {1}",
                         property.DeclaringType.ToString(), // OO: Den klass som deklarerar denna property
                         property.Name));
            }
        }
