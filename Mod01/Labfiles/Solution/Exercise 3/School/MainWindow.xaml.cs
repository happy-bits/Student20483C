            ...
            switch (e.Key)
            {
                ...
                case Key.Delete: student = this.studentsList.SelectedItem as Student;
                    ...
                    MessageBoxResult response = MessageBox.Show(
                        $"Remove {student.FirstName + " " + student.LastName}",       // OO: text
                        "Confirm",                                                    // OO: caption (titel)
                        MessageBoxButton.YesNo,     // OO: Vilken knapp eller knappar som ska visas
                        MessageBoxImage.Question,   // OO: Ikon
                        MessageBoxResult.No);       // OO: Defaultvärdet
