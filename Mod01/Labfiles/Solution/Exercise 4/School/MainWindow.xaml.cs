...
namespace School
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            teachersList.DataContext = this.schoolContext.Teachers; // OO: Comboboxen binds till lärarna (i databasen)
        }
        ...
        private void teachersList_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            this.studentsInfo = ((IListSource)teacher.Students).GetList(); // OO: "studentsInfo" är en lista i minnet 
        ...
        private void studentsList_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.Key)
            {
                ...
                case Key.Enter: 
                    ...
                    Student student = this.studentsList.SelectedItem as Student; // OO: Hämta vald student från ListView'n (inte databasen)
                    ...
                    // OO: Exekveringen stannar vid sf.ShowDialog(), tills användaren stängt ner fönstret
                    // Display the form
    ...
    // OO: ändrat namn. Detta klassnamn används XAML
    // OO: konverterar från en sträng till en decimal
    [ValueConversion(typeof(string), typeof(decimal))]
    class AgeConverterXXX : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter,
                              System.Globalization.CultureInfo culture)
        {
            // OO: Anropas en gång per student. Om ny student läggs in så anropas de nigen
